                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="li-product-thumbnail"><a href="#"><img src="{{asset('frontend/assets')}}/images/product/small-size/5.jpg" alt="Li's Product Image"></a></td>
                                ...
                                <tr>
                                    <td class="li-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                    <td class="li-product-thumbnail"><a href="#"><img src="{{asset('frontend/assets')}}/images/product/small-size/6.jpg" alt="Li's Product Image"></a></td>
