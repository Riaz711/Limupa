                                                ...
                                                <div class="single-product-wrap">
                                                    ...
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            ...
                                                            <div class="price-box">
                                                                 <span class="new-price new-price-2">TK.{{number_format($product->selling_price)}}</span>
                                                                <span class="old-price">TK.{{number_format($product->regular_price)}}</span>
                                                        ...
                                                        <div class="add-actions">
                                                            <ul class="add-actions-link">
                                                                <li class="add-cart active"><a href="{{route('cart.show')}}">Add to cart</a></li>
                                            ...
                                            <div class="col">
                                                    ...
                                                    <div class="col-lg-3 col-md-5 ">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                               <img src="{{asset('frontend/assets')}}/images/product/large-size/12.jpg" alt="Li's Product Image">
                                                            </a>
                                                            <span class="sticker">New</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row product-layout-list">
                                                    <div class="col-lg-3 col-md-5 ">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                               <img src="{{asset('frontend/assets')}}/images/product/large-size/11.jpg" alt="Li's Product Image">
                                                            </a>
                                                            <span class="sticker">New</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row product-layout-list">
                                                    <div class="col-lg-3 col-md-5 ">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                               <img src="{{asset('frontend/assets')}}/images/product/large-size/10.jpg" alt="Li's Product Image">
                                                            </a>
                                                            <span class="sticker">New</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row product-layout-list">
                                                    <div class="col-lg-3 col-md-5 ">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                               <img src="{{asset('frontend/assets')}}/images/product/large-size/9.jpg" alt="Li's Product Image">
                                                            </a>
                                                            <span class="sticker">New</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row product-layout-list">
                                                    <div class="col-lg-3 col-md-5 ">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                               <img src="{{asset('frontend/assets')}}/images/product/large-size/8.jpg" alt="Li's Product Image">
                                                            </a>
                                                            <span class="sticker">New</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row product-layout-list">
                                                    <div class="col-lg-3 col-md-5 ">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                               <img src="{{asset('frontend/assets')}}/images/product/large-size/7.jpg" alt="Li's Product Image">
                                                            </a>
                                                            <span class="sticker">New</span>
                                                        </div>
                                                    </div>
                                        ...
                                        {{-- <form action="#"> --}}
                                            <ul>
                                                ...
                                                <li><input type="checkbox" name="product-categori">
                                                    <a href="{{route('category.products',$category->id)}}">{{$category->name}}</a></li>
                                                @endforeach
                                            </ul>
                                        {{-- </form> --}}
                                    </div>
